...
import { getSender, getSenderPic, getSenderId } from "../HelperFunction/chat.Helper";
                  ...
                  <div className="chat-box flex items-center cursor-pointer">
                    <div className="profile relative">
                      <img
                        ...
                        alt="user_logo"
                      />
                      {!item.isGroupChat && onlineUsers.includes(getSenderId(loggedUser, item.users)) && (
                    ...
                    <div className="details w-3/4">
                      ...
                      <p className=" text-xs truncate whitespace-nowrap overflow-hidden">
                        <span className="text-xs">
                          {item.latestMessage != null && item.latestMessage.sender
                            ? `${
